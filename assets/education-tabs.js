function openTab(event, tabId) {
    ...
    if (tabId === 'pdfTab') { // Replace 'pdfTabContentId' with the actual ID of your PDF tab content
        newUrl = '?tab=pdfs';
    } else if (tabId === 'videoTab') { // Replace 'videoTabContentId' with the actual ID of your Video tab content
        newUrl = '?tab=videos';
    }
